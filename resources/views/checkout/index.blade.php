                            ...
                            <div class="mt-3">
                                <span class="small text-muted">
                                    <span class="checkout-subscription">
                                        {!! __('By continuing, you agree with the :terms and authorize :title to charge your payment method on a recurring basis.', ['terms' => mb_strtolower('<a href="/pages/terms-and-conditions" target="_blank">' . __('Terms and Condition') . '</a>'), 'title' => '<strong>' . e(config('settings.title')) . '</strong>']) !!} {{ __('You can cancel your subscription at any time.') }}
                                    </span>
                                </span>
                            </div>
